...
echo -e "\e[1m\e[32m2. Install alat tempur... \e[0m" && sleep 1
# packages
...
echo -e "\e[1m\e[32m3. Downloading and building bahan dasar... \e[0m" && sleep 1
